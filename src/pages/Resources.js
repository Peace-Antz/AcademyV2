  ...
  return (
    <Box sx={{ padding: 8 }}>
      ...
      <Typography level="h3" color="primary" gutterBottom>
        A comprehensive portal designed to support our Students, Teachers, and Sponsors!
      </Typography>
      ...
      <Box sx={{ marginTop: 2 }}>
        <Typography>
          ...
          <ol>
            ...
            <li>Scroll down and check out the titles and descriptions of the courses, if one interests you, open up the syllabus to see the details by clicking somewhere on the course.</li>
            <li>If you can attend the course, click "Enroll", and confirm the transaction to stake the enrollment fee (you can withdraw this before the course starts, once the course starts, your stake will be locked up until you pass the class).</li>
            ...
            <li>Once the teacher passes you, you will receive your staked enrollment fee back!</li>
          </ol>
        </Typography>
      </Box>
      </AccordionDetails>
      ...
      <Box sx={{ marginTop: 2 }}>
        ...
        Here are the steps you need to take to create your course:
          <ol>
            ...
            <li>If you have a syllabus already, then upload it in .pdf format. Otherwise you can use <Link href="https://chat.openai.com/" target="_blank">ChatGPT</Link>, <Link href="https://www.bing.com/search?q=Bing+AI&showconv=1&FORM=hpcodx" target="_blank">Bing Chat</Link> our your favorite AI tool to create a syllabus. </li>
            ...
            <li>To pass a student you must select the student's address from the dropdown list and click the "Pass Student" button.</li>
            <li>If the student does not pass the class, you can boot them by clicking the "Boot Student" button.</li>
            <li>Once you have passed at least one student you can click the "Claim Payout" button, if you fail to pass students who completed the course this will reflect poorly in your on-chain record.</li>
          </ol>
      ...
      <Box sx={{ marginTop: 2 }}>
        ...
        Here is how to sponsor a course:
          <ol>
            ...
            <li>Put in the amount (in MATIC) you would like to sponsor. You can put as little as you want and up to the amount still needed to start the course.</li>
            <li>If you have a syllabus already, then upload it in .pdf format. Otherwise you can use <Link href="https://chat.openai.com/" target="_blank">ChatGPT</Link>, <Link href="https://www.bing.com/search?q=Bing+AI&showconv=1&FORM=hpcodx" target="_blank">Bing Chat</Link> our your favorite AI tool to create a syllabus. </li>
            <li>Click "Sponsor" and confirm the transaction.</li>
          </ol>
